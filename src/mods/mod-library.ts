...
export const ElementTags = [Tag.Fire, Tag.Cold, Tag.Lightning, Tag.Poison];
const DirectDamageTags = [Tag.Attack, Tag.Spell, Tag.DoT, Tag.Elemental, ...ElementTags]
...
export const ElementalDamage = new ModBuilder(Tag.Damage, [Tag.Damage, Tag.Elemental, ...ElementTags], 'Element DMG');
...
export const MainElementDamage = new ModBuilder(Tag.Damage, [Tag.Damage, Tag.Physical, ...ElementTags], 'Main Element Damage');
 ...
 * Seals
 */
export const AuraAndSealEffect = new ModBuilder(Tag.Seal, [Tag.Effect], 'Aura and Seal Effect');
